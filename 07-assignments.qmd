...
The header of our [main website](https://thomaselove.github.io/432-2023/) links to detailed instructions for [Projects](https://thomaselove.github.io/432-2023/projA.html), [Quizzes](https://thomaselove.github.io/432-2023/quiz1.html) and [Labs](https://thomaselove.github.io/432-2023/lab1.html), and the [Minute Paper details](https://github.com/THOMASELOVE/432-minute-2023) are here.

## Deadlines for Assignments

All deadlines are posted as part of the [Course Calendar](https://thomaselove.github.io/432-2023/calendar.html), and the Calendar is the final word for all deadlines.
...
2. Contribute to [Campuswire](https://campuswire.com/) with questions, answers and helpful comments. That'll help us recognize you as someone trying to improve their understanding.
  - If you find **typos** in the materials (code, slides, the Notes, this syllabus) send them to us on [Campuswire](https://campuswire.com/) using the **Typos** category. 
...
The [Course Calendar](https://thomaselove.github.io/432-2023/calendar.html) provides deadlines for all Labs, and instructions for each Lab are available on [our main website](https://thomaselove.github.io/432-2023/).
...
The [Course Calendar](https://thomaselove.github.io/432-2023/calendar.html) provides deadlines for each of the Quizzes, and the [main course website](https://thomaselove.github.io/432-2023/) provides links at the top to each Quiz.

You will receive access to the quiz 3-4 days before it is due, and each quiz will be designed to take about six hours to complete, so the time pressure should be minimal. **If you need to make alternate arrangements for a Quiz, please contact Professor Love via email as soon as possible**, at least a week before a Quiz is released. 
...
During the semester, you will have two projects to complete. Complete instructions for [Project A](https://thomaselove.github.io/432-2023/projA.html) and for [Project B](https://thomaselove.github.io/432-2023/projB.html) are available now, through the link at the top of our main course website.

- [Project A](https://thomaselove.github.io/432-2023/projA.html) anticipates you using materials from 431 and from the first 12 classes of 432.
- [Project B](https://thomaselove.github.io/432-2023/projB.html) anticipates you using materials from the entire semester.

The [Course Calendar](https://thomaselove.github.io/432-2023/calendar.html) provides deadlines for all Project elements.

...
- 20 points for completing the [Welcome to 432  survey](https://bit.ly/432-2023-welcome-survey) that most of you did prior to class, and if you haven't done it, please do so now.
- plus up to 60 additional points for responses to the 12 assigned minute papers (5 points for each on-time submission.)
...
The eight Main Labs are graded by the Teaching Assistants, according to a rubric and answer sketch. In grading labs, everything counts, including the quality of the presentation, as well as the coding and statistical work. 
...
All Labs should be turned in by the deadline specified on the [Course Calendar](https://thomaselove.github.io/432-2023/calendar.html). In this class, it is far better to turn in timely, but only partially complete work than nothing at all. We don't give extensions on Labs. Instead, we use the following grading policy.
...
- Labs turned in more than 12 hours after the deadline will lose 20% of available points.
- No extensions to Lab deadlines will be permitted this semester. 

Your lowest lab score (out of eight) over the course of the semester will be dropped before we calculate your overall lab grade. 
...
[Bonus Lab X](https://thomaselove.github.io/432-2023/labX.html) will be graded according to the specifications provided in the Deadline section of that Lab.

## Lab Appeal Policy - Request a Review via Google Form

Clarification of concerns related to potential typographical or other errors in our Lab answer sketches is welcome at any time, but haggling over points on assignments can be a real time sink in a large class. To that end, students are **requested not to dispute** any grading on Labs during the semester. Instead, should you receive a lower grade on a Lab than you feel you deserve based on the feedback the TA provides, the answer sketch and the grading rubric, you can submit a request for a regrade by Professor Love by submitting the Google Form found at <https://bit.ly/432-2023-lab-regrades> by the deadline in the [Calendar](https://thomaselove.github.io/432-2023/calendar.html).
